      ...
      <div className="about-layout">
        <div className="about-grid">
          <figure className="about-figure">
            <div className="about-portrait">
              <Image
                ...
                sizes="(min-width: 1100px) 280px, 220px"
                placeholder="blur"
                priority
              />
            </div>
          ...
          <div className="about-prose">
            ...
            <p>
              Right now, I&apos;m building <CogitoMention /> around a simple belief:{" "}
              <strong>every idea deserves a proper home</strong>. Alongside it, I&apos;m working on an
              app that uses <strong>AI agents to run a car rental business from your phone</strong>,
              and improving{" "}
              <CompanyLink
                name="BeSeen"
