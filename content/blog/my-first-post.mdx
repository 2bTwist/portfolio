...
Want to <Mark variant="highlight">highlight something important</Mark>? Yellow background works great.
...
<img src="/images/first-image.png" alt="Example diagram" className="max-w-2xl mx-auto" />

_(Yeah, it's just a test sketch, but you get the idea.)_
